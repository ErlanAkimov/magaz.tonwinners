...
import { changeAddress } from '../../redux/slice/userSlice';
...
export const ChangeAddress = () => {
	...
	const [name, setName] = useState(myAddress.name);
	const [country, setCountry] = useState(myAddress.country);
	const [state, setState] = useState(myAddress.state);
	const [city, setCity] = useState(myAddress.city);
	const [street, setStreet] = useState(myAddress.street);
	const [zip, setZip] = useState(myAddress.zip);
