...
import { addToCart, emptyCart, inOrderToggler, removeFromCart } from '../../redux/slice/userSlice';
...
export const Orderspage = () => {
	...
	return (
		<div className={styles.wrapper}>
			...
			{
				user.cart.length === 0 && <ButtonDefault onClick={(() => navigate('/'))}>{user.appLanguage === 'ru' ? 'Вернуться на главную' : 'Back to home'}</ButtonDefault>
			}
